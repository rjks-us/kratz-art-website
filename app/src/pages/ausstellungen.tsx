    ...
    return (
        <>
            <div className="flex flex-col items-center bg-[#EEEAE4] min-h-screen">
                ...
                <div className="w-full p-4 bg-[#E2DEDB] flex justify-center items-center">
                    <p className="font-light text-lg md:text-xl text-black">Keine Ausstellungen gefunden</p>
                </div>
            </div>
